...
class EarningsControllerTest < ActionController::TestCase
  ...
  test "should create earning" do
    assert_difference('Earning.count') do
      post :create, earning: { amount: @earning.amount, business: @earning.business, date: @earning.date, user_id: @earning.user_id }
    end
  ...
  test "should update earning" do
    patch :update, id: @earning, earning: { amount: @earning.amount, business: @earning.business, date: @earning.date, user_id: @earning.user_id }
    assert_redirected_to earning_path(assigns(:earning))
  end
